...
# --- IMPORT MODULAR ---
from Retrieve_Data.Historical_Data.get_bnb import fetch_historical_data
from Clean_Data.cleaning_data import clean_historical_batch
from Retrieve_Data.Realtime_Data.get_realtime_bnb import start_realtime_tracking
...
# Setup Path File agar rapi
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
FILE_PATH = os.path.join(BASE_DIR, 'Data', 'historical_bnb.csv')
